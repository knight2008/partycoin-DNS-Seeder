...
public:
  ...
  CDnsSeedOpts() : nThreads(96), nDnsThreads(4), nPort(53001), mbox(NULL), ns(NULL), host(NULL), tor(NULL), fUseTestNet(false), fWipeBan(false), fWipeIgnore(false), ipv4_proxy(NULL), ipv6_proxy(NULL) {}

  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Partycoin-seeder\n"
...
static const string mainnet_seeds[] = {"sipa.partycoin.net", "bert.partycoin.info", "matt.party-coin.com", ""};
//  {"partycoin.net",  " sipa.partycoin.net "},		uk.bitmark.one
//  {"partycoin.info", " bert.partycoin.info "},	zappa.bitmark.one
//  {"party-coin.com", " matt.party-coin.com "}
static const string testnet_seeds[] = {"testnet-seed.partycoin.net",
                                       "testnet-seed.partycoin.info",
                                       "testnet-seed.party-coin.com",
                                       ""};
...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 7028), true);
  }
  do {
